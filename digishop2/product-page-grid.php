...
<!-- product-page-grid.html   07:30:36 GMT -->
...
<body>
                        ...
                        <div class="inner-page-main-body">
                            ...
                            <div class="tab-content">
                                <div role="tabpanel" class="tab-pane fade in active clear products-container" id="gried-view">
                                    <div class="product-grid-view padding-narrow" id="product-holder">
                                        <div class="row">
                                            <?php
                                                            ...
                                                            <div class="item-content">
                                                                ...
                                                                <div class="item-profile">
                                                                    <div class="profile-title">
                                                                        <div class="img-wrapper"><img style="height: 35px;" src="<?php echo $row['profile_pic']; ?>" alt="profile" class="img-responsive img-circle"></div>
                            ...
                            <div class="sidebar-item">
                                <div class="sidebar-item-inner">
                                    ...
                                    <div id="price-range-wrapper" class="price-range-wrapper">
                                        ...
                                        <button class="sidebar-full-width-btn disabled" type="submit" value="Login" onclick="priceFilter(2)">
    ...
    <script>
        var initialProducts = document.getElementById("product-holder").innerHTML;

        function sortProduct(event, category, type) {
            event.preventDefault();

            $.ajax({
                url: 'product-page-grid-helper.php',
                method: "POST",
                data: {
                    category: category,
                    type: type
                ...
                success: function(response) {
                    ...
                    document.getElementById("product-holder").innerHTML = response;
                    //console.log(response);
                }
            })
        }
        ...
        function priceFilter(type) {
            console.log(type);
            var minPrice = parseInt(document.getElementById("price-range-min").innerHTML.slice(1));
            var maxPrice = parseInt(document.getElementById("price-range-max").innerHTML.slice(1));
...
<!-- product-page-grid.html   07:31:23 GMT -->
