                ...
                <div class="inner-page-main-body">
                    ...
                    <div class="tab-content">
                            ...
                            <div class="product-grid-view padding-narrow">
                                <div class="row" id="item-grid-type">
                                    ...
                                    foreach ($marketplace_ids as $id) {
                                        ...
                                        AND a.marketplace_id = $id AND a.cat_id = '$category' ORDER BY a.created_date DESC";
                        ...
                        foreach($marketplace_ids as $id){
                            $sql = "SELECT a.id, a.vendor_id, a.cat_id, a.sub_cat_id, a.banner,
                            a.title, a.description, a.specifictaions, a.tags, a.views, a.price, b.name, b.profile_pic FROM
                            marketplace_digital_products a INNER JOIN vendor b ON a.status=1 AND b.id = a.vendor_id AND a.cat_id = '$category'
