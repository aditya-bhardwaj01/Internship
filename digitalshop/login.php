...
<!-- login.html  [XR&CO'2014], 1 08:12:39 1 -->
<head>	
<?php echo $head_tag; ?>
</head>
			...
			<div class="container">
				<div class="maan-user-account-wraper wow fadeInUp">
					<div class="user-header-area">
						<a href="index.html" class="logo d-none d-sm-block"><img src="assets/img/logo/logo.png" alt="Logo"></a>
						<nav>
							<div class="nav nav-tabs maan-swetch-btn" id="nav-tab" role="tablist">
							  <button class="nav-link login-btn maan-btn active" id="Login-tab" data-bs-toggle="tab" data-bs-target="#Login" type="button" role="tab" aria-selected="true">Login</button>
							  <button class="nav-link registration-btn" id="registration-tab" data-bs-toggle="tab" data-bs-target="#registration" type="button" role="tab" aria-selected="false">Registration</button>
							</div>
						</nav>
					</div>
					  <div class="tab-content" id="nav-tabContent">
						<div class="tab-pane fade active show" id="Login" role="tabpanel" aria-labelledby="Login-tab">
							<form>
								...
								<span class="forget-pass">Forget Password ? <a href="account.html">Click Here</a></span>
						...
						<div class="tab-pane fade" id="registration" role="tabpanel" aria-labelledby="registration-tab">
							<form>
								...
								<span class="forget-pass m-0">Don't have an account ? <a href="register.html">Create Account</a></span>
							</form>
						</div>
					</div>
				</div>
