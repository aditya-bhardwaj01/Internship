...
<body class="home bg-grey">
  <div style="padding: 2em"><?php echo date('M Y'); ?></div>
              ...
              <tr>
                <td data-title="Monday">
                  ...
                  <!-- <div class="tribe-events-category-tech-events">
                    <h6><a href="#" class="tribe-title">Hatha</a></h6>
                    Vicky Johnson
                ...
                <p>abcde</p>
                  <!-- <div class="tribe-events-category-tech-events">
                    <h6><a href="#" class="tribe-title">Yin Yoga</a></h6>
                    Alan Smith
                    <div class="tribe-events-tooltip">
                      <header>
                        <h6>Yin Yoga</h6>
                ...
                <p>abcde</p>
                  <!-- <div class="tribe-events-category-tech-events">
                    <h6><a href="#" class="tribe-title">Pilates</a></h6>
                    Stella Healy
                    <div class="tribe-events-tooltip">
                      <header>
                        <h6>Pilates</h6>
                ...
                <p>abcde</p>
                  <!-- <div class="tribe-events-category-tech-events">
                    <h6><a href="#" class="tribe-title">Restorative Yoga</a></h6>
                    Stella Healy
                    <div class="tribe-events-tooltip">
                      <header>
                ...
                <p>abcde</p>
                  <!-- <div class="tribe-events-category-tech-events">
                    <h6><a href="#" class="tribe-title">Gentle Yoga</a></h6>
                    Bradley Grosh
                    <div class="tribe-events-tooltip">
                      <header>
                        <h6>Gentle Yoga</h6>
