...
<body>
                            ...
                            <div class="col-md-3 mb-3">
                                <div class="product-gallery product-gallery-sticky product-gallery-vertical">
                                    <figure class="product-image">
                                        <img src="<?php echo $image; ?>" data-zoom-image="assets/images/products/without/1-800x900.jpg" alt="Bright Green IPhone" width="800" height="900">
                                    </figure>
                                </div>
                            </div>
                            <div class="col-md-8 mb-4 mb-md-6">
                                <div class="product-details">
                                    <h1 class="product-title"><?php echo $row['class_title'] ?> </h1>
                                    <div class="product-bm-wrapper">
                                        ...
                                        <div class="product-meta">
                                            <div class="product-categories">
                                                Category: <span class="product-category"><a href="#">Electronics</a></span>
                                            </div>
                                            <div class="product-sku">
                                                Address: <span>MS46891383</span>
                                            </div>
                                    ...
                                    <div class="product-countdown-container flex-wrap">
                                        ...
                                        <div id="main-event-countdown" style="color: blue; font-weight: bold;" data-until="2022, 12, 31" data-compact="true">
                                            <?php echo $row['start_time']; ?></div>
                                    </div>
                                    <hr class="product-divider">
                            ...
                            <div class="tab-pane active" id="product-tab-description">
                                <div class="row mb-4">
                                    ...
                                    <div class="col-md-6 mb-6">
                                        <h4 class="title tab-pane-title font-weight-bold mb-2">Sign up for a trial class
                                        </h4>
                                        <div class="modal-body">
                                            <div class="row gutter-sm">
                                                ...
                                                $arr = explode(",", $str);
                                                $vendor_id = (int)$arr[2];
                                                echo '<input type="hidden" id="vendor_id" value="'.$vendor_id.'">';
                                                ?>
                                                <div class="col-xs-12">
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="form-group">
                                                        <label>Email</label>
                                                        <input type="text" class="form-control form-control-md" id="email" name="lastname" required="">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12">
                                                    <div class="form-group">
                                                        <label>Mobile No</label>
                                                        <input type="text" class="form-control form-control-md" id="mobileno" name="lastname" required="">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 mb-3 mt-3">
                                                    <textarea class="form-control" rows="3" id="message" placeholder="Write about your Concerns"></textarea>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        <a href="#" id="submit-details" class="btn btn-dark btn-rounded btn-icon-left btn-shopping mr-auto">Submit</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <script>
        var valuestart = document.getElementById("main-event-countdown").innerHTML;

        setInterval(function() {
            var today = new Date();
            var valuestop = today.getHours() + ":" + today.getMinutes() + ":" + today.getSeconds();

            //create date format          
            var hour = new Date("01/01/2007 " + valuestart).getHours() - new Date("01/01/2007 " + valuestop).getHours();
            var minutes = new Date("01/01/2007 " + valuestart).getMinutes() - new Date("01/01/2007 " + valuestop).getMinutes();
            var seconds = new Date("01/01/2007 " + valuestart).getSeconds() - new Date("01/01/2007 " + valuestop).getSeconds();

            if (hour < 0) {
                hour = 24 - new Date("01/01/2007 " + valuestop).getHours() + new Date("01/01/2007 " + valuestart).getHours() - 1;
            }

            document.getElementById("main-event-countdown").innerHTML = hour + " hours";
        }, 1000);
                ...
                if (name == "" || email == "" || mobile == "" || msg == "") {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if(response == '1'){
                                swal("Good job!", "You response has been submitted!", "success");
                            }
                            else if(response == '0'){
                                swal("Sorry!", "Response can't be saved!", "error");
                            }
                        }
                    })
                }
