                    ...
                    <div class="product product-single row">
                        ...
                        <div class="col-md-8 mb-4 mb-md-6">
                            <div class="product-details">
                                <h1 class="product-title">Learn Website Development & DIGITAL MARKETING </h1>
                                            ...
                                            <div class="row gutter-sm">
                                                ...
                                                <div class="col-xs-12 mb-3 mt-3">
                                                    <textarea class="form-control" rows="3" id="message"
                                                        placeholder="Write about your Concerns"></textarea>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-7">
                                                        <a href="#"
                                                            class="btn btn-dark btn-rounded btn-icon-left btn-shopping mr-auto">Submit</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
