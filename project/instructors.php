...
<!-- vendor-dokan-store-grid 11:49:28 GMT -->
                ...
                <div class="container">
                    ...
                    <div class="toolbox vendor-toolbox pb-0">
                        <div class="toolbox-left mb-4 mb-md-0">
                            ...
                            <?php
                            $sql = "SELECT * FROM vendor WHERE vendor_type = 32";
                            ...
                            ?>
                            <label class="d-block">Total Store Showing <?php echo $count ?></label>
                        </div>
                                ...
                                <div class="store store-grid">
                                    <div class="store-header">
                                        <figure class="store-banner">
                                            <img src="<?php echo $value['background_image']; ?>" alt="Vendor" width="400" height="194" style="background-color: #40475E" />
                                        </figure>
                                    </div>
                                    <!-- End of Store Header -->
                                    <div class="store-content">
                                        <h4 class="store-title">
                                            <a href="vendor-dokan-store.html"><?php echo $value['name']; ?></a>
                                        ...
                                        <div class="store-address">
                                            <?php echo $value['city'] . ' ' . $value['state']; ?>
                                        </div>
                                        <ul class="seller-info-list list-style-none">
                                            <li class="store-phone">
                                                <a href="tel:1234567890"><i class="w-icon-phone"></i><?php echo $value['mobile']; ?></a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="store-footer">
                                        <figure class="seller-brand">
                                            <img src="<?php echo $value['company_logo']; ?>" alt="Brand" width="80" height="80" />
                                        </figure>
