...
<body>
                ...
                <div class="container">
                    ...
                    <div class="shop-content row gutter-lg mb-10">
                            ...
                            <div class="sidebar-content scrollable">
                                ...
                                <div class="sticky-sidebar">
                                    ...
                                    <div class="widget widget-collapsible">
                                        <h3 class="widget-title"><span>Class level</span></h3>
                                        <ul class="widget-body filter-items search-ul">
                                            <?php
                                            $sql = "SELECT class_level FROM add_teacher WHERE site_id = $this_site_id";
                                            $res = mysqli_query($conn, $sql);

                                            while($row = mysqli_fetch_assoc($res)){
                                            ?>                                            
                                            <li><a href="#" onclick="fetchFromTeacher(event, '<?php echo $row['class_level']; ?>', 1)"><?php echo $row['class_level']; ?></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>

                                    <div class="widget widget-collapsible">
                                        <h3 class="widget-title"><span>Class focus</span></h3>
                                        <ul class="widget-body filter-items search-ul">
                                        <?php
                                            $sql = "SELECT class_focus FROM add_teacher WHERE site_id = $this_site_id";
                                            $res = mysqli_query($conn, $sql);

                                            while($row = mysqli_fetch_assoc($res)){
                                            ?>                                            
                                            <li><a href="#" onclick="fetchFromTeacher(event, '<?php echo $row['class_focus']; ?>', 2)"><?php echo $row['class_focus']; ?></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div>

                                    <div class="widget widget-collapsible">
                                        <h3 class="widget-title"><span>Class fees</span></h3>
                                        <ul class="widget-body filter-items search-ul">
                                            <li><a href="#" onclick="fetchFromTeacher(event, '0,200', 3)">
                                                    <p class="lower-val" style="display: inline;">$00.00</p>-<p class="higher-val" style="display: inline;">$200.00</p>
                                                </a></li>
                                            <li><a href="#" onclick="fetchFromTeacher(event, '201,500', 3)">
                                                    <p class="lower-val" style="display: inline;">$201.00</p>-<p class="higher-val" style="display: inline;">$500.00</p>
                                                </a></li>
                                            <li><a href="#" onclick="fetchFromTeacher(event, '501,1000', 3)">
                                                    <p class="lower-val" style="display: inline;">$501.00</p>-<p class="higher-val" style="display: inline;">$1000.00</p>
                                                </a></li>
                                            <li><a href="#" onclick="fetchFromTeacher(event, '1001,1300',3)">
                                                    <p class="lower-val" style="display: inline;">$1001.00</p>-<p class="higher-val" style="display: inline;">$1300.00</p>
                                                </a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="main-content">
                            ...
                            <div class="product-wrapper row cols-lg-4 cols-md-3 cols-sm-2 cols-2" id="product-holder-section">
                                <?php
                                ...
                                FROM add_teacher a INNER JOIN product_images b ON a.site_id = $this_site_id AND b.marketplace_id = 16";
                                $res = mysqli_query($conn, $sql);
                                $countCurrent = 0;
                                ...
                                ?>
                                    <div class="product-wrap" style="padding: 1em;">
                                        <div class="product text-center">
                                            <figure class="product-media"> 
                                                <a href="class-detail.php?detail=<?php echo $row['id'].','.$row['image_url'].','.$row['class_instructor']; ?>">
                                            ...
                                            <div class="product-details">
                                                <div class="product-cat">
                                                    <a href="class-detail.php?detail=<?php echo $row['id'].','.$row['image_url'].','.$row['class_instructor']; ?>"><?php echo $row['class_title']; ?></a>
                                                </div>
                                                <h3 class="product-name">
                                                    <a href="class-detail.php?detail=<?php echo $row['id'].','.$row['image_url'].','.$row['class_instructor']; ?>"><?php echo $row['class_level']; ?></a>
                                                </h3>
                                                <div class="product-pa-wrapper">
                                                    <div class="product-price">Duration:
                                                        <?php echo writeMsg($row['start_time'], $row['end_time']); ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="toolbox toolbox-pagination justify-content-between">
                                <p class="showing-info mb-2 mb-sm-0">
                                    Showing<span>1 -<span id="current-showing"><?php echo $countCurrent; ?></span> of <span id="total-showing"><?php echo $countCurrent; ?></span>Products
                                </p>
                                <!-- <ul class="pagination">
    ...
    <script>
        ...
        var total = 0;
        // Showing<span>1-<span id="current-showing">12</span> of <span id="total-showing">60</span>Products

        function fetchFromTeacher(ev, cat, id) {
            currentShowing = 0;
            first = 1;
            var load_flag = 0;
            lazyLoadingTeacher(ev, cat, id, load_flag);
            load_flag += 4;
            $(window).scroll(function() {
                var windowHeight = $(window).height();
                var windowTop = $(window).scrollTop() + 1;
                if (windowTop >= windowHeight) {
                    windowHeight = $(window).height() + windowTop - 1000;
                    lazyLoadingTeacher(ev, cat, id, load_flag);
                    load_flag += 4;
                }
            });
        ...
        function lazyLoadingTeacher(ev, cat, Id, st) {
            ev.preventDefault();
            $.ajax({
                url: "fetch_add_teacher.php",
                type: "POST",
                data: {
                    category: cat,
                    id: Id,
                ...
                success: (response) => {
                    ...
                    currentShowing += data[1];
                    if (first === 1) {
                        $("#product-holder-section").html("");
                        first = 0;
                    }
                    $("#current-showing").html(currentShowing);
                    $("#total-showing").html(data[2]);
                    $("#product-holder-section").append(data[0]);
                }
            });
        }
    </script>
</body>
<!-- shop-grid-4cols 11:47:29 GMT -->
