...
<!-- blog-grid-sidebar 11:48:37 GMT -->
                    ...
                    <div class="row gutter-lg">
                        <div class="main-content">
                            <div class="row cols-sm-2">
                                <?php
                                $sql = "SELECT a.*, b.name FROM post a INNER JOIN vendor b WHERE a.site_id = $this_site_id AND 
                                a.vendor_id=b.id";
                                ...
                                ?>
                                    <article class="post post-grid-type overlay-zoom mb-6 fashion">
                                        <figure class="post-media br-sm">
                                            <a href="post-single.php?id=<?php echo $row['id']; ?>">
                                        ...
                                        <div class="post-details">
                                            ...
                                            <h4 class="post-title">
                                                <a href="post-single.php?id=<?php echo $row['id']; ?>"><?php echo $row['post_title']; ?></a>
                                            </h4>
                                            <div class="post-content">
                                                <p>
                                                    <?php echo substr($row['post_description'], 0, 200); ?>
                                                    <?php if (strlen($row['post_description']) > 200) echo '...'; ?>
                                                </p> <a href="post-single.php?id=<?php echo $row['id']; ?>" class="btn btn-link btn-primary">(read more)</a>
                                            </div>
                                            <div class="post-meta">
                                                by <a href="#" class="post-author"><?php echo $row['name']; ?></a>
                                                - <a href="#" class="post-date">
                                                    ...
                                                    echo $days + $years * 365 + $months * 30;
                                                    ?> days ago
                                                </a>
                                                <a href="#" class="post-comment"><i class="w-icon-comments"></i><span><?php echo $row['views']; ?></span>Views</a>
                                            </div>
                                        </div>
                                    </article>
                                <?php
                                ...
                                <div class="sticky-sidebar">
                                    ...
                                    <div class="widget widget-categories mb-0">
                                        ...
                                        <ul class="widget-body filter-items search-ul">
                                            <?php
                                            $sql = "SELECT distinct(category_title) FROM categories WHERE site_id = $this_site_id";
                                            $res = mysqli_query($conn, $sql);
                                            if (!$res) {
                                                errlog(mysqli_error($conn), $sql);
                                            }
                                                ...
                                                <div class="swiper-container swiper-theme nav-top" data-swiper-options="{
                                                    ...
                                                    <div class="swiper-wrapper row cols-1">
                                                        <div class="swiper-slide widget-col">
                                                            <?php
                                                            $sql = "SELECT * FROM post WHERE site_id = $this_site_id ORDER BY views DESC LIMIT 3";
                                                            $res = mysqli_query($conn, $sql);
                                                            if (!$res) {
                                                                errlog(mysqli_error($conn), $sql);
                                                            }
                                                                ...
                                                                <div class="post-widget mb-4">
                                                                    ...
                                                                    <div class="post-details">
                                                                        <div class="post-meta">
                                                                            <a href="#" class="post-date">
                                                                                <?php
                                                                                $date = date('F-d-Y', strtotime($row['created_date']));
                                                                                echo $date;
                                                                                ?>
                                                                            </a>
                                                                        </div>
                                    ...
                                    <div class="widget widget-tags">
                                        ...
                                        <div class="widget-body tags">
                                            <?php
                                            $sql = "SELECT tags FROM post WHERE site_id = $this_site_id ORDER BY views DESC LIMIT 3";
                                            $res = mysqli_query($conn, $sql);
                                            if (!$res) {
                                                errlog(mysqli_error($conn), $sql);
                                            }
                                            ...
                                            $tags = array();
                                            foreach($res as $tag){
                                                $singleTag = explode(',', $tag['tags']);
                                                foreach($singleTag as $ele){
                                                    array_push($tags, $ele);
                                                }
                                            }
...
<!-- blog-grid-sidebar 11:48:38 GMT -->
