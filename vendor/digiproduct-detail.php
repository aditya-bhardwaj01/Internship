...
$item_id = realEscape(urldecode(base64_decode($_GET['id'])));
$item_id = 1;
?>
        ...
        <main class="main mb-10 pb-1">
            ...
            <div class="page-content">
                ...
                $sql = "SELECT * FROM marketplace_digital_products WHERE site_id='$this_site_id'
                                AND status=1 AND verified=1 AND id = $item_id";
                            ...
                            <!-- <div class="col-md-3 mb-3">
                                <div class="product-gallery product-gallery-sticky product-gallery-vertical">
                                    <figure class="product-image">
                                        <img src="<?php echo  htmlspecialchars($row['banner']); ?>" data-zoom-image="<?php echo  htmlspecialchars($row['banner']); ?>" alt="Bright Green IPhone" width="1000" height="900">
                                    </figure>
                                </div>
                            </div> -->
                                    ...
                                    <div class="swiper-container product-single-swiper swiper-theme nav-inner" data-swiper-options="{
                                        ...
                                        <div class="swiper-wrapper row cols-1 gutter-no">
                                            <div class="product-thumb swiper-slide">
                                                <img src="<?php echo  htmlspecialchars($row['banner']); ?>" alt="<?php echo $row['title']; ?>" width="800" height="900">
                                            </div>
                                            <?php
                                            $sqlSlider = "SELECT image_url FROM product_images WHERE product_id = '$item_id' AND type='IMAGE'
                                            AND main=0 AND marketplace_id=27";
                                            $resSlider = mysqli_query($conn, $sqlSlider);
                                            if (!$resSlider) {
                                                errlog(mysqli_error($conn), $sqlSlider);
                                            }
                                            ...
                                            AND main=0 AND marketplace_id=27";
                                                ...
                                                ?>
                                                    <div class="product-thumb swiper-slide">
                                                        <img src="<?php echo  htmlspecialchars($rowSlider['image_url']); ?>" alt="<?php echo $row['title']; ?>" width="800" height="900">
                                                    </div>
                                                <?php
                                                }
                                                ?>
                                            ...
                                            <!-- <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="<?php echo  htmlspecialchars($row['banner']); ?>" data-zoom-image="<?php echo  htmlspecialchars($row['banner']); ?>" alt="<?php echo  htmlspecialchars($row['title']); ?>" width="800" height="900">
                                                </figure>
                                            </div> -->
                                        </div>
                            ...
                            <div class="col-md-5 mb-4 mb-5">
                                <div class="product-details">
                                    ...
                                    <div class="product-bm-wrapper">
                                        <?php
                                        $vendor_id = $row['vendor_id'];
                                        $sqlLogo = "SELECT company_logo FROM vendor WHERE id=$vendor_id and site_id='$this_site_id'";

                                        $resLogo = mysqli_query($conn, $sqlLogo);
                                        if (!$resLogo) {
                                            errlog(mysqli_error($conn), $sqlLogo);
                                        }
                                        foreach ($resLogo as $rowLogo) {
                                        ?>
                                            <figure class="brand">
                                                <img src="<?php echo  htmlspecialchars($rowLogo['company_logo']); ?>" alt="Brand" width="105" height="28" />
                                            </figure>
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <div class="product-meta">
                                        <div class="product-categories">
                                            Category: <span class="product-category"><a href="#"><?php echo  htmlspecialchars($row['cat_id']); ?></a></span>
                                        </div>
                                        <div class="product-categories">
                                            Type: <span class="product-category"><a href="#"><?php echo  htmlspecialchars($row['type']); ?></a></span>
                                        </div>
                                        <div class="product-categories">
                                            Access type: <span class="product-category"><a href="#"><?php echo  htmlspecialchars($row['access_type']); ?></a></span>
                                        </div>
                                    ...
                                    <div class="product-categories">
                                        Version: <span class="product-category"><a href="#"><?php echo  htmlspecialchars($row['version']); ?></a></span>
                                    </div>
                                    <div class="product-categories">
                                        Compatible browser: <span class="product-category"><a href="#"><?php echo  htmlspecialchars($row['compatible_browsers']); ?></a></span>
                                    </div>
                                    <div class="product-categories">
                                        License type: <span class="product-category"><a href="#"><?php echo  htmlspecialchars($row['license_type']); ?></a></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3 mb-4 mb-5">
                                <div class="widget widget-icon-box mb-6 mt-5">
                                    <div class="row mt-5">
                                        <div class="col-md-7">
                                            <h5>Regular License</h5>
                                        </div>
                                        <div class="col-md-5 font-22">
                                            <h5 class="product-title"><ins class="new-price">&#8377;<?php echo htmlspecialchars($row['price']); ?>.00</ins></h5>
                                        </div>
                                    </div>
                                        ...
                                        <div class="fix-bottom product-sticky-content sticky-content">
                                            <div class="btn-group">
                                                <div class="btn-wrap show-code-action">
                                                    <a href="#" class="btn btn-sm btn-primary  btn-rounded">Buy</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="product-tab-description">
                                    ...
                                    <div class="home-images">
                                        <div class="row">
                                            <?php
                                            $sqlHome = "SELECT * FROM product_images WHERE product_id=$item_id AND type='HOME' AND main<>0
                                        AND marketplace_id=27";
                                            $resHome = mysqli_query($conn, $sqlHome);

                                            if (!$resHome) {
                                                errlog(mysqli_error($conn), $resHome);
                                            }

                                            foreach ($resHome as $rowHome) {
                                            ?>
                                                <div class="col-md-3">
                                                    <img style="height: 300px; width: 250px;" src="<?php echo htmlspecialchars($rowHome['image_url']) ?>" alt="" srcset="">
                                                </div>
                                                <!-- <div class="col-md-3">.col-6 .col-md-4</div>
                                            <div class="col-md-3">.col-6 .col-md-4</div>
                                            <div class="col-md-3">.col-6 .col-md-4</div> -->
                                            <?php
                                            }
                                    ...
                                    <div class="row mb-4">
                                        <div class="col-md-6 mb-5">
                                            ...
                                            <ul>
                                                <?php
                                                $featuresCol = decoder($row['features']);
                                                $features = explode(',', $featuresCol);
                    ...
                    <div class="col-md-8 p-3">
                        <section class="vendor-product-section">
                            ...
                            <div class="swiper-container swiper-theme" data-swiper-options="{
                                ...
                                <div class="swiper-wrapper row cols-lg-3 cols-md-4 cols-sm-3 cols-2">
                                    <?php
                                    $sql = "SELECT * FROM marketplace_digital_products WHERE site_id='$this_site_id'
                                    AND status=1 AND verified=1 AND vendor_id=$vendor_id AND cat_id='$category' AND id<>$item_id";
                                    ...
                                    <div class="swiper-slide product">
                                        <figure class="product-media">
                                            <a href="digiproduct-detail.php?id=<?php echo urlencode(base64_encode($row['id'])) ?>">
                                                <img src="<?php echo  htmlspecialchars($row['banner']); ?>" alt="Product" width="300" height="338" />
                                                <img src="<?php echo  htmlspecialchars($row['banner']); ?>" alt="Product" width="300" height="338" />
                                            </a>
                                        ...
                                        <div class="product-details">
                                            <div class="product-cat"><a href="digiproduct-detail.php?id=<?php echo urlencode(base64_encode($row['id'])) ?>">
                                            <?php echo  htmlspecialchars($row['cat_id']); ?>
                                        </a>
                                            </div>
                                            <h4 class="product-name"><a href="digiproduct-detail.php?id=<?php echo urlencode(base64_encode($row['id'])) ?>">
                        ...
                        <section class="related-product-section">
                            ...
                            <div class="swiper-container swiper-theme" data-swiper-options="{
                                ...
                                <?php
                                    $sql = "SELECT * FROM marketplace_digital_products WHERE site_id='$this_site_id'
                                    AND status=1 AND verified=1 AND sub_cat_id='$sub_category' AND cat_id='$category' AND id<>$item_id";
                                    ...
                                    <div class="swiper-slide product">
                                        ...
                                        <div class="product-details">
                                            <h4 class="product-name"><a href="digiproduct-detail.php?id=<?php echo urlencode(base64_encode($row['id'])) ?>"><?php echo  htmlspecialchars($row['title']); ?></a></h4>
                                            <div class="ratings-container">
                                                <div class="ratings-full">
                                                    <span class="ratings" style="width: 100%;"></span>
                                                    <span class="tooltiptext tooltip-top"></span>
                                            ...
                                            <div class="product-pa-wrapper">
                                                <div class="product-price">&#8377;<?php echo  htmlspecialchars($row['price']); ?>.00</div>
                                            </div>
                                        </div>
                                    </div>
                                    <?php
