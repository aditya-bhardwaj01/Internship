    ...
    <div class="page-wrapper">
        ...
        <main class="main mb-10 pb-1">
            ...
            <div class="page-content">
                <?php
                $sql = "SELECT a.*, b.image_url, c.company_logo FROM marketplace_digital_products a INNER JOIN product_images b INNER JOIN vendor c WHERE 
                c.id = a.vendor_id AND a.site_id = $this_site_id AND b.product_id=$id AND b.marketplace_id = 27 AND type = 'IMAGE' AND main = 1 AND a.id=$id";
                        ...
                        <div class="product product-single row">
                                        ...
                                        ?>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="<?php echo $image; ?>" data-zoom-image="assets/images/products/without/1-800x900.jpg" alt="<?php echo $row['title']; ?>" width="800" height="900">
                                                    <a href="#" class="product-gallery-button product-image-full"><i class="w-icon-zoom"></i></a>
                                                </figure>
                                            </div>
                                        <?php
                                        }
                                ...
                                <div class="product-gallery product-gallery-sticky">
                                    <div class="swiper-container product-single-swiper swiper-theme nav-inner" data-swiper-options="{
                                        ...
                                        ?>
                                            <div class="swiper-slide">
                                                <figure class="product-image">
                                                    <img src="<?php echo $image; ?>" data-zoom-image="<?php echo $image; ?>" alt="Electronics Black Wrist Watch" width="800" height="900">
                                                </figure>
                                            </div>
                                            <?php
                                        }
                                    ...
                                    <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                                        ...
                                        ?>
                                            <div class="product-thumb swiper-slide">
                                                <img src="<?php echo $image; ?>" alt="<?php echo $row['title']; ?>" width="800" height="900">
                                            </div>
                                            <?php
                                        }
                                        ?>
                            ...
                            <div class="col-md-5 mb-4 mb-5">
                                <div class="product-details">
                                    ...
                                    <div class="product-bm-wrapper">
                                        <figure class="brand">
                                            <img src="<?php echo $row['company_logo']; ?>" alt="Brand" width="90" height="48" />
                                        </figure>
                                    ...
                                    <div class="product-meta">
                                        <div class="product-categories">
                                            Category: <span class="product-category"><a href="#"><?php echo $row['cat_id']; ?></a></span>
                                        </div>
                            ...
                            <div class="col-md-3 mb-4 mb-5">
                                <div class="widget widget-icon-box mb-6 mt-5">
                                    <div class="row mt-5">
                                        <div class="col-md-7">
                                            <h5><?php echo $row['license_type'] ?> License</h5>
                                        </div>
                                        <div class="col-md-5 font-22">
                                            <h5 class="product-title"><ins class="new-price">&#8377;<?php echo $row['price'] ?>.00</ins></h5>
                                        </div>
                                    </div>
