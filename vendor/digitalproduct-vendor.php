                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table" id="datatable_1">
                                        ...
                                        <tbody>
                                            <?php
                                            $sql = "SELECT a.*, b.name from marketplace_digital_products a INNER JOIN vendor b where a.vendor_id=$vid 
                                            and a.site_id=$this_site_id and b.id=$vid";
                                            ...
                                            ?>
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br>
                                                        <a href="#" class="font-12 text-primary">Product Owner: <?php echo htmlspecialchars($row['name']) ?></a>
                                                        <br>
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dLabel1" style="">
                                                                    <ul class="list-inline mb-0">
                                                                        ...
                                                                        <a href="https://www.facebook.com/sharer/sharer.php?u=http://bit.ly/SYO3LX" target="_blank" data-mce-target="_blank" type="button" class="btn btn-soft-primary btn-icon-circle">
                                                                            ...
                                                                            <!-- https://www.instagram.com/shareArticle?mini=true&url=https://www.instagram.com/ -->
