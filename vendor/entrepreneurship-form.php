...
<body>
                                    ...
                                    <form id="membership_apply_form" name="membership_apply_form">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <!-- ye kya kara hua h ? pata nhi sir wo pehle se hi tha maine kuch nhi kia hai isme but kam kar rha hai koi error nhi aa rha ok vo file wala issue solve ho gya h ab jese normal file ko access karte h vese hi kar skte ho php m ok -->
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div class="checkbox-group required">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" id="inlineCheckbox2" name="service[]" value="Business Activites Updates">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" id="inlineCheckbox3" name="service[]" value="Consultation/Guidance">
                                                        Consultation/Guidance </label>
                                                </div>
                                                <div class="col-md-6">
                                                    <label class="checkbox-inline">
                                                        <input type="checkbox" id="inlineCheckbox4" name="service[]" value="Networking Opportunities">
                                        ...
                                        <div class="row">
                                            <div class="form-group">
                                                <div class="checkbox">
                                                    <label>
                                                        <input type="checkbox" required="" id="terms-cond" onchange="changeSubmitButton()">
    ...
    <script>
        function sendMail(ev) {
            ...
            $.ajax({
                url: "entrepreneurship_helper.php",
                type: "POST",
                data: myFormData,
                processData: false,
                contentType: false,
