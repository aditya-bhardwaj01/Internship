    ...
    <div class="page-wrapper">
        <div class="page-content-tab">
            <div class="container-fluid">
                ...
                $no_of_response = $data['RESPONSE']; // number of response per post from purchased package
                $sql2 = "SELECT * FROM response where item_id = '$id'";
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <div class="row align-items-center">
                                            <div class="col">
                                                <h4 class="card-title">Job Response <?= $no_of_response ?></h4>
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <input type="hidden" id="sid<?php echo $row1['id'] ?>" value="<?php echo $row1['id'] ?>" class="form-control" placeholder="ff" />
                ...
                if ($count > $no_of_response) {
                    echo "<div style='background-color:red;height : 30px;width : 550px;'><p><b>You have more responses in waiting.</b> Please buy a package to view all responses. </p></div>";  
                }

                    }
                } else echo 'Nobody responded to your jobs';
                ?>
            </div>
