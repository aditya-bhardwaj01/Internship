...
<body>
            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        <li><a href="shop-banner-sidebar.html">B-2-B Shop</a></li>
                    </ul>
                </div>
            </nav>
            <!-- End of Breadcrumb -->
            ...
            <div class="page-content mb-10">
                ...
                <div class="shop-content">
                    ...
                    <div class="main-content">
                        ...
                        <div class="product-wrapper row cols-lg-5 cols-md-4 cols-sm-3 cols-2" id="main-productarea">
                            <?php
                            $sql = "select a.*, b.image_url, c.price, c.mrp from marketplace_products a inner join product_images b on 
                                ...
                                product_variants c on a.id=c.product_id";
                                    ...
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="<?php echo htmlspecialchars($row['image_url']); ?>" alt="Product" width="300" height="250" />
                                            </a>
                                        ...
                                        <div class="product-details">
                                            <div class="product-cat">
                                                <a href="shop-banner-sidebar.html"><?php echo htmlspecialchars($row['cat_id']); ?></a>
                                            </div>
                                            <h3 class="product-name">
                                                <a href="product-default.html"><?php echo htmlspecialchars($row['product_title']); ?></a>
                                            </h3>
                                            ...
                                            <div class="product-pa-wrapper">
                                                <div class="product-price">
                                                    ...
                                                    - $<?php echo htmlspecialchars($row['mrp']); ?>.00
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="sidebar-content scrollable">
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                <div class="widget-body">
                                    <ul class="filter-items search-ul">
                                        <li onclick="changePrice(0, 100)"><a href="#">$0.00 - $100.00</a></li>
                                        <li onclick="changePrice(100, 200)"><a href="#">$100.00 - $200.00</a></li>
                                        <li onclick="changePrice(200, 300)"><a href="#">$200.00 - $300.00</a></li>
                                        <li onclick="changePrice(300, 500)"><a href="#">$300.00 - $500.00</a></li>
                                        <li onclick="changePrice(500, 10000000)"><a href="#">$500.00+</a></li>
                                    </ul>
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                <ul class="widget-body filter-items item-check mt-1">
                                    <?php
                                    $sql = "select distinct(cat_id) as category from marketplace_products where site_id = $this_site_id and save_type = 'BTB'";
                                    $res = mysqli_query($conn, $sql);

                                    foreach ($res as $row) {
                                    ?>
                                        <li active-status="not-active" id="<?php echo $row['category'] ?>" onclick="applyFilter('cat_id', '<?php echo $row['category'] ?>')"><a href="#"><?php echo htmlspecialchars($row['category']) ?></a></li>
                                    <?php
                                    }
                                    ?>
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                <ul class="widget-body filter-items item-check mt-1">
                                    <?php
                                    $sql = "select distinct(brand_name) as brand from marketplace_products where site_id = $this_site_id and save_type = 'BTB'";
                                    $res = mysqli_query($conn, $sql);

                                    foreach ($res as $row) {
                                    ?>
                                        <li active-status="not-active" id="<?php echo $row['brand'] ?>" onclick="applyFilter('brand_name', '<?php echo $row['brand'] ?>')"><a href="#"><?php echo htmlspecialchars($row['brand']) ?></a></li>
                                    <?php
                                    }
                                    ?>
                                </ul>
                            ...
                            <div class="widget widget-collapsible">
                                ...
                                <ul class="widget-body filter-items item-check">
                                    <?php
                                    $sql = "select distinct(label) as label from marketplace_products where site_id = $this_site_id and save_type = 'BTB'";
                                    $res = mysqli_query($conn, $sql);
                                    ...
                                    ?>
                                        ...
                                        if ($row['label'] == 1) {
                                        ?>
                                            <li active-status="not-active" id="promoted" onclick="applyFilter('label', 'promoted')"><a href="#">Promoted</li>
                                        <?php
                                        }
                                        ?>
                                        ...
                                        if ($row['label'] == 2) {
                                        ?>
                                            <li active-status="not-active" id="sponsored" onclick="applyFilter('label', 'sponsored')"><a href="#">Sponsored</a></li>
                                        <?php
                                        }
                                        ?>
                                        ...
                                        if ($row['label'] == 3) {
                                        ?>
                                            <li active-status="not-active" id="featured" onclick="applyFilter('label', 'featured')"><a href="#">Featured</a></li>
                                        <?php
                                        }
                                        ?>
    ...
    <script type="text/javascript">
        ...
        var initialContent = document.getElementById("main-productarea").innerHTML;
        ...
        function changePrice(low, high){
            ...
            highPrice = high;
            // if(filters.size == 0){
            //     document.getElementById("main-productarea").innerHTML = initialContent
            // }
            // else{
            //     callHelper()
            // }
        ...
        function applyFilter(type, filter){
            var activeStatus = document.getElementById(filter).getAttribute("active-status");
            if(activeStatus == 'not-active'){ 
                document.getElementById(filter).setAttribute("active-status", 'active');
                activeStatus = 'active'
            }
            else if(activeStatus == 'active'){ 
                document.getElementById(filter).setAttribute("active-status", 'not-active');
                activeStatus = 'not-active'
            }
            
            if(activeStatus == 'active'){
                filters.set(filter, type)
            }
        ...
        function callHelper(){
            $.ajax({
                url: "b2bproducts_helper.php",
                type: "POST",
                data: {
                    data: Array.from(filters.entries()),
                    lowPrice: lowPrice,
                    highPrice: highPrice
                },
                success: function(response) {
                    document.getElementById("main-productarea").innerHTML = response;
                }
            });
        }
    </script>
