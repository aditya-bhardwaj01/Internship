                                ...
                                <div class="sticky-sidebar">
                                    <div class="widget widget-collapsible widget-categories">
                                        ...
                                        <ul class="shipping-methods mb-2">
                                            <?php
                                            $cat_sql = "select distinct(Category) from marketplace_business where site_id = 
                                            '$this_site_id' and status='1'";
                                            $cat_row = $conn->query($cat_sql);
                                            if (!$cat_row) {
                                                errlog(mysqli_error($conn), $cat_sql);
                                            } else {
                                    ...
                                    <div class="widget widget-collapsible widget-categories">
                                        ...
                                        <div class="custom-radio ">
                                            <!-- <div class="slidecontainer">
                                                <input type="range" min="1" max="100" value="100" id="slider-filter" onchange="updateSliderVal()">
                                                <p id="price">&#8377;0 - &#8377;<span id="slider-value">100</span></p>
                                            </div> -->

                                            <input type="hidden" name="min_price" id="min_price" value="100">
                                            <input type="hidden" name="max_price" id="max_price" value="<?= $max_A ?>" 
                                            readonly class="border-0 amount text-center text-body font-weight-500">
                                            <p id="price">&#8377;0 - &#8377;<?= $max_A ?></p>
...
<script>
    ...
    function updateSliderVal() {
            var value = document.getElementById("slider-filter").value;
