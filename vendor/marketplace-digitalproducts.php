...
<body>
                                ...
                                <div class="sticky-sidebar">
                                    <div class="widget widget-collapsible widget-categories">
                                        ...
                                        <ul class="shipping-methods mb-2">
                                            <?php
                                            $sql = "SELECT distinct(a.cat_id) FROM marketplace_digiproducts a INNER JOIN categories b
                                                WHERE a.site_id = $this_site_id AND b.marketplace_id = 27 AND b.category_type = 'main'";
                                            ...
                                            ?>
                                                <li>
                                                    <div class="custom-radio">
                                                        <input type="radio" id="free-shipping<?php echo $count ?>" class="custom-control-input" name="shipping" onchange="applyCategory(this.value, '<?php echo $row['cat_id']; ?>')">
                                                        <label for="free-shipping<?php echo $count ?>" class="custom-control-label color-dark"><?php echo $row['cat_id']; ?></label>
                                                    </div>
                                                </li>
                                            <?php
                                                $count++;
                                            ...
                                            <div class="custom-radio">
                                                ...
                                                <label for="free-shipping"
                                                    class="custom-control-label color-dark">Category 1</label>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="custom-radio">
                                    ...
                                    <div class="widget widget-collapsible widget-categories">
                                        ...
                                        <ul class="shipping-methods mb-2">
                                            <?php
                                            $sql = "SELECT distinct(Label) FROM marketplace_digiproducts
                                            WHERE site_id = $this_site_id";
                                            $res = mysqli_query($conn, $sql);
                                            if (!$res) {
                                                errlog(mysqli_error($conn), $sql);
                                            }
                                            ...
                                            ?>
                                                <li>
                                                    <div class="custom-radio">
                                                        <input type="radio" id="free-shipping<?php echo $count ?>" class="custom-control-input" name="shipping" onchange="applyLabel(this.value, '<?php echo $row['Label']; ?>')">
                                                        <label for="free-shipping<?php echo $count ?>" class="custom-control-label color-dark"><?php echo $row['Label']; ?></label>
                                                    </div>
                                                </li>
                                            <?php
                                                $count++;
                                            ...
                                            <!-- <li>
                                                <div class="custom-radio">
                                                    ...
                                                    <label for="free-shipping" class="custom-control-label color-dark">Sponsored</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="custom-radio">
                                                    <input type="radio" id="free-shipping" class="custom-control-input" name="shipping">
                                                    <label for="free-shipping" class="custom-control-label color-dark">Promoted</label>
                                                </div>
                                            </li> -->
                                        </ul>
                                    </div>
                                    ...
                                    <input type="range" min="1" max="100" value="100" onchange="changePrice(this.value)">
                                    <p style="font-weight: bold;">$0 - $<span id="upper-range">100</span></p>
                                    <!-- Price Slider end -->
                            ...
                            <div class="tab tab-nav-underline tab-nav-boxed tab-vendor-wcfm">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="tab-1">
                                        ...
                                        <div class="col-md-4 col-6" id="main-area-digiproducts">
                                            <?php
                                            ...
                                            b.marketplace_id = 27 AND a.price<=100";
                                            ...
                                            <div class="swiper-slide product product-image-gap product-simple">
                                                <div class="product-label-group">
                                                    <label class="product-label label-new"><?php echo $row['Label']; ?></label>
                                                </div>
                                                <figure class="product-media">
                                                    <a href="digiproduct-detail.php?id=<?php echo $row['id']; ?>">
                                                        <img src="<?php echo $row['image_url'] ?>" alt="Product" width="295" height="335" />
                                                    </a>
                                                ...
                                                <div class="product-details">
                                                    <div class="product-cat">
                                                        <a href="shop-banner-sidebar.html"><?php echo $row['cat_id'] ?></a>
                                                    </div>
                                                    <h3 class="product-name">
                                                        <a href="digiproduct-detail.php?id=<?php echo $row['id']; ?>"><?php echo $row['product_title'] ?></a>
                                                    </h3>
                                                    <!-- <div class="ratings-container">
                                                        <div class="ratings-full">
                                                            <span class="ratings" style="width: 100%;"></span>
                                                        ...
                                                        <a href="digiproduct-detail.php?id=<?php echo $row['id']; ?>" class="rating-reviews">(10 reviews)</a>
                                                    </div> -->
                                                    <div class="product-pa-wrapper">
                                                        <div class="product-price">
                                                            <ins class="new-price">INR <?php echo $row['price'] ?>.00</ins><del class="old-price">INR 60.00</del>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function changePrice(val) {
            price = val;
            document.getElementById('upper-range').innerHTML = price;
            applyFilter()
        }

        function applyCategory(status, val) {
            category = val;
            label = "";
            applyFilter()
        }

        function applyLabel(status, val) {
            category = "";
            label = val;
            applyFilter()
        }
        ...
        function applyFilter() {
            $.ajax({
                type: "POST",
                url: "marketplace_digitalproducts_helper.php",
                data: {
                    price: price,
                    category: category,
                    label: label
                ...
                success: function(response) {
                    ...
                    document.getElementById("main-area-digiproducts").innerHTML = response
                }
            });
        }
    </script>
