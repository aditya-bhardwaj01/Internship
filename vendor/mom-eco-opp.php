            ...
            <div class="container pb-2">
				<div class="swiper-container swiper-theme category-banner-3cols pt-2 pb-2 mb-2 appear-animate"
                    ...
                    <div class="swiper-wrapper row cols-lg-3 cols-sm-2 cols-1">
                        <div class="swiper-slide banner banner-fixed category-banner layer-overlay1">
                            <figure class="br-sm">
                                <img src="https://www.financialexpress.com/wp-content/uploads/2021/04/Jobs1.jpg" alt="Category Banner" width="400"
                                    height="200" style="background-color: #4F4B48; height:165px; width:312px;" />
                            </figure>
                            <div class="banner-content y-50" style="padding:10px;">
                               <h4 class="banner-title text-white text-capitalize ls-10">Jobs</h4>
                        ...
                        <div class="swiper-slide banner banner-fixed category-banner layer-overlay1">
                            <figure class="br-sm">
                                <img src="https://fjwp.s3.amazonaws.com/blog/wp-content/uploads/2019/12/18070716/Untitled-design-9.png" alt="Category Banner" width="400"
                                    height="200" style="background-color: #A3A3A3; height:165px; width:312px;" />
                            </figure>
                            <div class="banner-content y-50" style="padding:10px;">
                               <h4 class="banner-title text-white text-capitalize ls-10">Gigs</h4>
                                <a href="shop-banner-sidebar.html" class="btn btn-dark btn-link btn-underline btn-icon-right text-white">
                                    Explore<i class="w-icon-long-arrow-right"></i>
                                </a>
                            </div>
                        ...
                        <div class="swiper-slide banner banner-fixed category-banner layer-overlay1">
                            <figure class="br-sm">
                                <img src="https://i.cdn.newsbytesapp.com/images/l72520220210154358.jpeg" alt="Category Banner" width="400"
                                    height="200" style="background-color: #151A1E; height:165px; width:312px;" />
                            </figure>
                            <div class="banner-content y-50" style="padding:10px;">
                               <h4 class="banner-title text-white text-capitalize ls-10">Articleship</h4>
                                <a href="shop-banner-sidebar.html" class="btn btn-dark btn-link btn-underline btn-icon-right text-white">
                                    Explore<i class="w-icon-long-arrow-right"></i>
                                </a>
                            </div>
                        ...
                        <div class="swiper-slide banner banner-fixed category-banner layer-overlay1">
                            <figure class="br-sm">
                                <img src="https://bremerwhyte.com/wp-content/uploads/2018/12/bigstock-Recruitment-Concept-Words-Emp-256358128-1024x683.jpg" alt="Category Banner" width="400"
                                    height="200" style="background-color: #151A1E;height:165px; width:312px;" />
                            </figure>
                            <div class="banner-content y-50" style="padding:10px;">
                               <h4 class="banner-title text-white text-capitalize ls-10">Contracual Job</h4>
                                <a href="shop-banner-sidebar.html" class="btn btn-dark btn-link btn-underline btn-icon-right text-white">
                                    Explore<i class="w-icon-long-arrow-right"></i>
                                </a>
                            </div>
			 ...
			 <div class="container">
                ...
                <div class="title-link-wrapper title-select after-none appear-animate">
                    <h2 class="title font-secondary font-weight-bolder">Employment Opportunites</h2>
                ...
                <div class="swiper-container swiper-theme select-product-wrapper shadow-swiper appear-animate pb-2 mb-10"
                    ...
                    <div class="swiper-wrapper row cols-lg-5 cols-md-4 cols-sm-3 cols-2">
                        <div class="swiper-slide product product-image-gap product-simple">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="https://hiring-assets.careerbuilder.com/media/attachments/careerbuilder-ar_post-1773.jpg?1464647352" alt="Product" width="295"
                            ...
                            <div class="product-details">
                                ...
                                <h4 class="product-name">
                                    <a href="product-default.html">Full Time Job</a>
                                </h4>
                                <div class="ratings-container">
                                    <a href="product-default.html" class="rating-reviews">(12 Matching Jobs)</a>
                                </div>
                            </div>
                        </div>
                        <div class="swiper-slide product product-image-gap product-simple">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="https://cdn2.vectorstock.com/i/1000x1000/57/01/part-time-job-word-concepts-banner-temporary-vector-29165701.jpg" alt="Product" width="295"
                                        height="235" /  style="height:185px; width:283px;">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
                            ...
                            <div class="product-details">
                                <a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
                                <h4 class="product-name">
                                    <a href="product-default.html">Part Time Job</a>
                                </h4>
                                <div class="ratings-container">
                                   <a href="product-default.html" class="rating-reviews">(12 Matching Jobs)</a>
                                </div>
                        ...
                        <div class="swiper-slide product product-image-gap product-simple">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="https://ainetx.online/assets/uploads/media-uploader/commission-structure-featured-image-e15271009636901623869005.jpg" alt="Product" width="295"
                                        height="235" /  style="height:185px; width:283px;">
                               </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
                            ...
                            <div class="product-details">
                                <a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
                                <h4 class="product-name">
                                    <a href="product-default.html">Performace Based job</a>
                                </h4>
                                <div class="ratings-container">
                                    <a href="product-default.html" class="rating-reviews">(12 Matching Jobs)</a>
                                </div>
                        ...
                        <div class="swiper-slide product product-image-gap product-simple">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="https://aniportalimages.s3.amazonaws.com/media/details/Contractual_Employment_Aug25_UZfMXf1.jpg" alt="Product" width="295"
                                        height="235" /  style="height:185px; width:283px;">
                                </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
                            ...
                            <div class="product-details">
                                <a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
                                <h4 class="product-name">
                                    <a href="product-default.html">Contractual Job</a>
                                </h4>
                                <div class="ratings-container">
                                    <a href="product-default.html" class="rating-reviews">(12 Matching Jobs)</a>
                                </div>
                        ...
                        <div class="swiper-slide product product-image-gap product-simple">
                            <figure class="product-media">
                                <a href="product-default.html">
                                    <img src="https://static01.nyt.com/images/2008/12/12/travel/12ashrams_600.jpg?quality=75&auto=webp&disable=upscale" alt="Product" width="295"
                                        height="235" /  style="height:185px; width:283px;">
                                    </a>
                                <div class="product-action-vertical">
                                    <a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
                            ...
                            <div class="product-details">
                                <a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
                                <h4 class="product-name">
                                    <a href="product-default.html">Gig Jobs</a>
                                </h4>
                                <div class="ratings-container">
                ...
                <div class="title-link-wrapper title-deals after-none appear-animate mt-2">
                    <h2 class="title font-secondary mb-1">Entrepreneurship Opportunities</h2>
                    <a href="shop-boxed-banner.html" class="font-weight-bold ls-25">
                        More
                        <i class="w-icon-long-arrow-right"></i>
                    </a>
                    ...
                    <div class="swiper-slide ">
								...
								<div class="product-details">
									...
									<div class="ratings-container">
										...
										<a href="product-default.html" class="rating-reviews">(1 Listing)</a>
									</div>
								</div>
							</div>
                        </div>
						<div class="swiper-slide ">
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">Liasioning</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
						...
						<div class="swiper-slide ">
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">Legal Drafting</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
                        ...
                        <div class="swiper-slide ">
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">License & Approval</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
						 ...
						 <div class="swiper-slide ">
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">Content Writing</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
               ...
               <!-- End of Swiper -->
                <div class="title-link-wrapper title-deals after-none appear-animate mt-2">
                    <h2 class="title font-secondary mb-1">Business Opportunity</h2>
                    <a href="shop-boxed-banner.html" class="font-weight-bold ls-25">
                        More
                        <i class="w-icon-long-arrow-right"></i>
                    </a>
                ...
                <div class="swiper-container swiper-theme mb-4 pg-inner animation-slider" data-swiper-options="{
                    ...
                    <div class="swiper-slide ">
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">Start Up</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
						...
						<div class="swiper-slide ">
								<div class="swiper-slide product product-image-gap product-simple">
									<figure class="product-media">
										<a href="product-default.html">
											<img src="https://www.marketreview.com/wp-content/uploads/2019/09/bullion.jpg" alt="Product" width="295"
												height="335" /  style="height:185px; width:283px;">
										</a>
										<div class="product-action-vertical">
											<a href="#" class="btn-product-icon btn-compare w-icon-compare" title="Compare"></a>
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">Bullions</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
						...
						<div class="swiper-slide ">
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">Equity</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
                        ...
                        <div class="swiper-slide ">
								...
								<div class="product-details">
									<a href="#" class="btn-wishlist w-icon-heart" title="Add to wishlist"></a>
									<h4 class="product-name">
										<a href="product-default.html">Bonds& Shares</a>
									</h4>
									<div class="ratings-container">
										<div class="ratings-full">
											<span class="ratings" style="width: 80%;"></span>
