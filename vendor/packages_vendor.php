...
<body id="body" class="dark-sidebar">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table" id="datatable_1">
                                            ...
                                            <tbody>
                                                ...
                                                $sql = "SELECT a.*, b.marketplace_name, c.amount FROM purchased_packages a INNER JOIN
                                                        marketplace_list b INNER JOIN orders c WHERE a.vendor_id = $id AND b.id = a.package_type
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if((int)$diff->format('%R%a days')+$row['validity'] < 0){
                                                                echo $pre;
                                                            }
                                                            else{
                                                                echo $pre.$post;
                                                        ...
                                                        <td>
                                                            ...
                                                            if ((int)$diff->format('%R%a days')+$row['validity'] < 0) {
                                                                echo '<span class="badge badge-soft-pink">Expired</span>';
                                                            } else {
                                                        ...
                                                        <td>
                                                            <a id="edit-vendor" href="#"><i class="mdi mdi-pencil text-secondary font-16"></i></a>
                                                            <a id="delete-vendor" href="#"><i class="mdi mdi-delete-forever text-secondary font-16"></i></a>
                                                        </td>
    ...
    <script>
        document.getElementById('delete-vendor').onclick(function(){
            console.log(123);
        })
    </script>
</body>
