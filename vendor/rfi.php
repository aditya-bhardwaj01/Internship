...
<body>
            ...
            <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        <li><a href="rfq">Request for Information</a></li>
                    </ul>
                </div>
            </nav>
            <div class="page-content">
                <div class="container">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php
                        // $ids = $_GET['id'];
                        // $array_ids = explode(',',urldecode(base64_decode($ids)));  
                        // $strId = '';
                        // for($i = 0; $i<sizeof($array_ids); $i++){
                        //     $strId .= $array_ids[$i];
                        //     if($i != sizeof($array_ids)-1){
                        //         $strId .= ',';
                        //     }
                        // }  
                        ?>
                        <!-- <input id="tagsinput" type="text" value="<?php echo $strId; ?>" data-role="tagsinput" > -->
                        <div class="row gutter-sm">
                            <div class="row gutter-sm">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-md" id="information" name="information" placeholder="Information Asked for" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
                                <textarea id="purpose" name="purpose" class="form-control" rows="3" id="message" placeholder="Purpose for Information"></textarea>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row gutter-sm">
                            <div class="col-xs-6">
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-md" id="company" name="company" placeholder="Company Name (Optional)" required>
                                </div>
                            </div>
                            <div class="col-xs-6">
                            </div>
    ...
    <script>
        $("#purpose").summernote({
            placeholder: "Purpose for information"
        })
        ...
        function submitData(event) {
            ...
            if (information == '') {
                swal({
                    title: "Information is empty!",
                    text: "Please enter Information asked for",
                    icon: "error",
                    timer: 3000,
                    button: false
                });
            ...
            if (purpose == '') {
                swal({
                    ...
                    text: "Please enter Purpose of Information",
                    icon: "error",
                    timer: 3000,
                    button: false
                });
            ...
            myFormData.append('information', information);
            myFormData.append("purpose", purpose);
            myFormData.append("type", 'rfi');
