						...
						<div class="row mb-3">
							<div class="col-md-6">
									<select class="form-control" id="project-timeline" name="project-timeline">
										...
										<option value="1">Within 15 Days</option>
										<option value="1">Within a month</option>
									</select> 
							</div>
							<div class="col-xs-6">
                                     <div class="form-group">
						 ...
						 <h5>Contact Details</h5>
									<div class="row gutter-sm">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-md" id="name" name="name" placeholder="Full Name"
                                                    required>
                                            </div>
                                        </div>
									   <div class="col-xs-6">
									 ...
									 <div class="row gutter-sm">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-md" name="company" id="company"  placeholder="Company Name (Optional)"
                                                    required>
                                            </div>
                                        </div>
                                        </div>
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <input type="tel" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" class="form-control form-control-md" id="mobile" name="mobile" placeholder="Mobile"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
									<div class="row gutter-sm">
                                        <div class="col-xs-6">
                                            <div class="form-group">
                                                <input type="text" class="form-control form-control-md" id="designation" name="designation"  placeholder="Designation"
                                                    required>
                                            </div>
                                        </div>
                                    </div>
