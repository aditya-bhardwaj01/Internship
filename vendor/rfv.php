...
<body>
			  ...
			  <nav class="breadcrumb-nav">
                <div class="container">
                    <ul class="breadcrumb bb-no">
                        ...
                        <li><a href="rfq">Request for Vendor Empanelment</a></li>
                    </ul>
                </div>
            </nav>
						 ...
						 <div class="row gutter-sm">
                             <div class="col-xs-12">
                                 <div class="form-group">
                                   <input type="text" class="form-control form-control-md" name="company-name" id="company-name" placeholder="Company Name" required>
                                </div>
                            </div>
                         </div>
						<div class="row mb-3">
							<textarea class="form-control" rows="3"  name="about-company" id="about-company" placeholder="About Our Company"></textarea>
						</div>

						<div class="row mb-3">
							<textarea class="form-control" rows="3"  name="service" id="service" placeholder="Services We provide"></textarea>
						</div>
						<div class="row mb-3">
							<div class="col-xs-6">
                                 <div class="form-group">
                                   <input type="number" class="form-control form-control-md" name="experience" id="experience" placeholder="Total Years of Experience" required>
                                </div>
                            </div>
							<div class="col-xs-6">
                                 <div class="form-group">
                                   <input type="text" class="form-control form-control-md" name="industry" id="industry" placeholder="Industries We worked for" required>
                                </div>
                            </div>
							<div class="row mb-3">
								<textarea class="form-control" rows="3" name="client" id="client" placeholder="Client We Have Worked for"></textarea>
							</div>
						</div>
						<div class="row mb-3">
							<div class="col-xs-6">
							...
							<h6>Attach Company Profile. Only PDF is allowed</h6>
							</div>
						</div>
					</div>
						 <hr>
    ...
    <script>
        function submitData(event) {
            ...
            if (companyName == '') {
                swal({
                    title: "companyName is empty!",
                    text: "Please enter companyName",
                    icon: "error",
                    timer: 3000,
                    button: false
                });
            ...
            var aboutCompany = document.getElementById('about-company').value;
            if (aboutCompany == '') {
                swal({
                    title: "aboutCompany is empty!",
                    text: "Please enter aboutCompany",
                    icon: "error",
                    timer: 3000,
                    button: false
                });
            ...
            myFormData.append('companyName', companyName);
            myFormData.append("aboutCompany", aboutCompany);
            myFormData.append("service", service);
            myFormData.append('experience', experience);
            myFormData.append("industry", industry);
            myFormData.append("client", client);
            myFormData.append("profile", profile);
            myFormData.append("type", 'rfv');
