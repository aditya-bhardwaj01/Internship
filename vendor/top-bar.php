            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        <img src="<?php if(htmlspecialchars($result['profile_pic']) != '') echo htmlspecialchars($result['profile_pic']); else echo $avatar; ?>" alt="" class="rounded-circle me-2 thumb-sm" />
                        <div>
                            <small class="d-none d-md-block font-11"><?php if (isset($_SESSION['admin_id'])) echo 'Admin'; else if (isset($_SESSION['vendor_id'])) echo 'Vendor' ;  else echo 'Guest' ;?></small>
                            <span class="d-none d-md-block fw-semibold font-12"><?php echo htmlspecialchars($result['name']) ?><i class="mdi mdi-chevron-down"></i></span>
                        </div>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <?php } else {
                        ?>
                        <a class="dropdown-item" href="../vendor/product_shop"><i class="ti ti-power font-16 me-1 align-text-bottom"></i> Login</a>
                        <?php
                    } ?>
                </div>
            </li>
