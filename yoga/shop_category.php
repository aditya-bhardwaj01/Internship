...
<body>
    ...
    <div id="content" class="page-content-wrap">
      ...
      <div class="container wide3">
        ...
        <div class="row">
            ...
            <div class="product-sort-section flex-row justify-content-between align-items-center">
              ...
              <div class="mad-custom-select">
                <select data-default-text="Default sorting">
                  <option value="Option 1">Latest-Oldest</option>
                  <option value="Option 2">Oldest-Latest</option>
                  <option value="Option 3">Low-High</option>
                  <option value="Option 2">High-Low</option>
                  <option value="Option 3">A-Z</option>
                </select>
              </div>
              ...
              <div class="products-holder flex-row item-col-3">
                ...
                <div class="product">
                  ...
                  <figure class="product-image">
                    <a href="#"><img src="https://velikorodnov.com/html/jogasana/images/289x286_img2.jpg" alt=""></a>
                  </figure>
          ...
          <aside id="sidebar" class="col-lg-3 col-md-12">
            ...
            <div class="widget">
              ...
              <form class="search-form">
                ...
                <input id="category" type="text" placeholder="Search Products">
            ...
            <div class="widget">
              ...
              <fieldset class="price-scale">
                ...
                <div class="clearfix range-values">
                  ...
                  <div class="f-right">
                    <a href="#" class="btn btn-small f-right">Filter</a>
                  </div>
                </div>
              </fieldset>
          ...
          <button id="brute-load" class="btn btn-primary">Load more</button>
  ...
  <script>
    ...
    function getdata(sortBy, order, cat, load_flag) {
      $.ajax({
        url: "GetImage.php",
        type: "POST",
        data: {
        ...
        success: function(response) {
          if (onceDone === 0 || isNew) {
            $(".products-holder").html("");
            onceDone = 1;
            isNew = 0;
          }
          $('.products-holder').append(response);
        }
      });
    }

    function lazyLoading(sortBy, order, cat) {
      var load_flag = 0;
      getdata(sortBy, order, cat, load_flag);
      load_flag += 6;
      $(window).scroll(function() {
        var windowHeight = $(window).height();
        var windowTop = $(window).scrollTop() + 1;
        if (windowTop >= windowHeight) {
          windowHeight = $(window).height() + windowTop - 10;
          getdata(sortBy, order, cat, load_flag);
          load_flag += 6;
        }
      });
    ...
    $(function() {
      // <select data-default-text="Default sorting">
      $(".mad-custom-select select").on('change', function() {
        var sortBy = $('.mad-selected-option').text();
        var category = $("#category").val();

        if (sortBy === 'Latest-Oldest') {
          isNew = 1;
          lazyLoading(sortBy, "DESC", category);
        }

        if (sortBy === 'Oldest-Latest') {
          isNew = 1;
          lazyLoading(sortBy, "ASC", category);
        }
